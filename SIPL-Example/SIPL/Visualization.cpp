...
void Visualization::display() {
    ...
    gtk_widget_add_events(GTK_WIDGET(eventBox), GDK_SCROLL_MASK);
    gtk_signal_connect(
			GTK_OBJECT (eventBox),
            "scroll-event",
            G_CALLBACK(Visualization::scrollEvent),
            this
    );
...
#ifdef USE_GTK
void Visualization::scrollEvent(GtkWidget * widget, GdkEventScroll * event, gpointer user_data) {
