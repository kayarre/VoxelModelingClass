...
void initGLUT(int *argc, char **argv) {
  ...
  glutInitWindowSize(W, H);
  glutInitWindowPosition(W, 1);
  window_1 = glutCreateWindow("Volume Visualizer");
  glutSetWindowTitle("Volume Visualizer");
  //init();
  glutInitWindowSize(W, H);
  glutInitWindowPosition(1, W);
  window_2 = glutCreateWindow("Window 2");
  glutSetWindowTitle("Window 2");
  //init();
